    ...
    <section className="main-section">
      <div className="content-split flex-col">
        ...
        <p className="p-primary">
          O meu interesse pelo I Ching começou há mais de dez anos, após ter-me
          começado a interessar por literatura oriental, na qual encontrei
          alguns conceitos como o Yin Yang e o Tao que eventualmente me levaram
          ao I Ching.
        </p>
        <p className="p-primary">
          Atendendo a que recentemente decidi aprender web developing, este
          website pareceu-me a melhor forma de fazer uma ferramenta que me fosse
          útil e que também mostrasse alguns dos meus conhecimentos de
          programação.
        </p>
        <p className="p-primary">
        ...
        <p className="p-primary">
          Resumidamente usei o Next JS 15, Tailwind CSS e SQLite. Inicialmente,
          usei base de dados local (com DBeaver), mas entretanto para produção
          em Vercel tive de mudar e optei pelo Turso. Não usei nenhum ORM pois
          gostaria de trabalhar com SQL diretamente.
        </p>
